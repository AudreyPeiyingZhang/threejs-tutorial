...
import ww from '../Assets/Models/peiying_car.glb'
...
class CubeEnvironment extends Component {
    ...
    constructor(props) {
		...
		this.overlayItem = new OverlayItem(
			"Lumi Xu", 
			"VIDEO", 
			"https://www.youtube.com/embed/r0FpAnqsti0"
		)
      }
	...
	populateScene = () => {
		...
		//this.addCube( new THREE.Vector3(0,0,0),this.overlayItem);
		 this.addModel(ww, new THREE.Vector3(0,0,0), this.overlayItem);
		this.setupFog();
	};
	 ...
	 */
	setupFog = () => {
		this.scene.fog = new THREE.FogExp2(new THREE.Color('white'), 0.05); // Color, Density
	};
